  ...
  const questions = [
    {
      ...
      options: [
        ...
        { id: 'c', text: "Stop immediately and grade during school hours tomorrow", isCorrect: false, explanation: "While respecting rest time is good, this adds pressure to find time during busy school hours. A compromise is better." },
        { id: 'd', text: "Work until midnight to get it all done", isCorrect: false, explanation: "This severely impacts your sleep and well-being. It's not sustainable and affects your effectiveness as a teacher." },
         { id: 'b', text: "Grade for 30 minutes, then save the rest for tomorrow", isCorrect: true, explanation: "Setting a time limit respects your sleep schedule and maintains work-life balance. You can finish tomorrow with fresh energy." },
      ]
    },
    {
      id: 2,
      ...
      options: [
        { id: 'c', text: "Spend focused time with family, then plan lessons afterward", isCorrect: true, explanation: "This honors both commitments by giving each focused attention. Quality family time is essential for your well-being." },
        { id: 'a', text: "Plan lessons while spending time with family", isCorrect: false, explanation: "Divided attention doesn't serve either purpose well. Both family time and planning deserve focused attention." },
        { id: 'b', text: "Tell them you're too busy and continue planning", isCorrect: false, explanation: "This neglects your family's need for connection. It can strain relationships and doesn't support work-life balance." },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'c', text: "Do 2 hours tonight and 3 hours Monday morning", isCorrect: false, explanation: "Starting Monday with a heavy workload doesn't support a balanced start to the week. Planning ahead is better." },
        { id: 'b', text: "Spread the grading across Monday to Thursday, doing 1 hour each day", isCorrect: true, explanation: "Distributing workload prevents weekend burnout and maintains boundaries between work and personal time." },
