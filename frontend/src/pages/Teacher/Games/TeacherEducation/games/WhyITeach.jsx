                ...
                {emotionTags.map((tag) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        <h4 className={`font-bold text-lg mb-1 ${
                          responses[currentQuestionIndex].selectedEmotion === tag.id ? 'text-gray-800' : 'text-gray-700'
                        }`}>
                          {tag.label}
                        </h4>
                      </div>
                    ...
                    <p className={`text-sm leading-relaxed ${
                      responses[currentQuestionIndex].selectedEmotion === tag.id ? 'text-gray-800' : 'text-gray-600'
                    }`}>
                      {tag.description}
                    </p>
                  </motion.button>
