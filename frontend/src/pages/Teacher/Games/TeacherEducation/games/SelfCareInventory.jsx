...
const SelfCareInventory = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      emoji: '👥',
      options: [
        { value: 1, label: 'Setting clear boundaries while staying connected with supportive colleagues', isCorrect: true, explanation: 'Boundaries prevent burnout while connections provide essential support' },
        { value: 2, label: 'Avoiding all workplace interactions to prevent drama', isCorrect: false, explanation: 'Isolation increases stress and reduces job satisfaction' },
        { value: 3, label: 'Befriending everyone regardless of professional appropriateness', isCorrect: false, explanation: 'Blurred boundaries can create complications and stress' },
        { value: 4, label: 'Keeping work completely separate from personal life', isCorrect: false, explanation: 'Some integration is healthy; complete separation isnt realistic or beneficial' }
      ]
    },
    {
      id: 4,
      ...
      emoji: '✨',
      options: [
        { value: 1, label: 'Remembering why you became a teacher and connecting with your core values', isCorrect: true, explanation: 'Reconnecting with your mission provides motivation during difficult periods' },
        { value: 2, label: 'Focusing only on test scores and measurable outcomes', isCorrect: false, explanation: 'Numbers alone dont sustain long-term motivation or fulfillment' },
        { value: 3, label: 'Comparing yourself to other teachers who seem more successful', isCorrect: false, explanation: 'Comparison often decreases confidence and satisfaction' },
    ...
    },
    {
      ...
      emoji: '🍎',
      options: [
        { value: 1, label: 'Building small, consistent healthy habits into your routine', isCorrect: true, explanation: 'Small sustainable changes create lasting wellness improvements' },
        { value: 2, label: 'Intense workout sessions when you have free time', isCorrect: false, explanation: 'Inconsistent intense exercise is hard to maintain and can lead to injury' },
          ...
          <div className="text-center">
            <motion.button
              ...
              className={`px-8 py-4 rounded-xl font-semibold text-lg shadow-lg transition-all flex items-center gap-3 mx-auto ${
                (selectedOption !== null && questionAnswered)
