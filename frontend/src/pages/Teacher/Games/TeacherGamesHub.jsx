...
import { ArrowRight, Gamepad2, Sparkles, Heart, Brain } from "lucide-react";
...
const TeacherGamesHub = () => {
  ...
  const { user } = useAuth();
  const teacherEducationGames = getAllTeacherEducationGames();
  ...
  const gameCategories = [
    {
      ...
      gamesCount: teacherEducationGames.length,
      emoji: "🧠",
    },
            ...
            <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 px-6 py-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-4xl font-black text-white mb-1">Teacher Module</h1>
        ...
        >
          {gameCategories.map((category, index) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-3xl border-2 ${category.borderColor} bg-gradient-to-br ${category.bgGradient} shadow-xl cursor-pointer transition-all hover:shadow-2xl hover:border-indigo-400`}
            >
          ...
          >
            ...
            <div className="relative h-full flex flex-col justify-center">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                Earn Healcoins by completing games and improve your teaching practice while taking care of your mental wellbeing.
              </p>
            </div>
          </motion.div>
        </motion.div>
