...
const MissedEMIConsequence = () => {
  ...
  const baseKey = "financial-literacy.adults.missed-emi-consequence";
  ...
  const headerLeft = t(`${baseKey}.sectionHeaderLeft`, {
    defaultValue: "EMI Responsibility",
  });
  const headerRight = t(`${baseKey}.sectionHeaderRight`, {
    defaultValue: "Payment Consequences",
  });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Missed EMI Consequence"}
      subtitle={subtitle}
