...
const WhatIsInterest = () => {
  ...
  const baseKey = "financial-literacy.adults.what-is-interest";
  ...
  // Guard placed after all hooks (Rule of Hooks safe).
  ...
  const headerLeft = t(`${baseKey}.sectionHeaderLeft`, {
    defaultValue: "Interest Basics",
  });
  const headerRight = t(`${baseKey}.sectionHeaderRight`, {
    defaultValue: "Borrowing Costs",
  });
  ...
  return (
    <GameShell
      title={gameContent?.title || "What Is Interest?"}
      subtitle={subtitle}
