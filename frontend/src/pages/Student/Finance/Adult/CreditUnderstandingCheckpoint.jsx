...
const CreditUnderstandingCheckpoint = () => {
  ...
  const baseKey = "financial-literacy.adults.credit-understanding-checkpoint";
  ...
  return (
    <GameShell
      title={gameContent?.title || "Credit Understanding Checkpoint"}
      subtitle={subtitle}
      ...
      <div className="space-y-5 text-white">
        <div className="bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-4 text-sm uppercase tracking-[0.3em] text-white/60">
            ...
            <span>
              {t(`${baseKey}.scenarioValue`, { defaultValue: "Understanding Check" })}
            </span>
          </div>
            ...
            {showResult && (
              <>
                ...
                <p className="text-sm text-white/70">
                  ...
                  <strong>
                    {t(`${baseKey}.skillName`, {
                      defaultValue: "Credit fundamentals mastery",
                    })}
                  </strong>
                </p>
