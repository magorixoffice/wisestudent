...
const HigherLoanHigherCost = () => {
  ...
  const baseKey = "financial-literacy.adults.higher-loan-higher-cost";
  ...
  const headerLeft = t(`${baseKey}.sectionHeaderLeft`, {
    defaultValue: "Loan Sizing",
  });
  const headerRight = t(`${baseKey}.sectionHeaderRight`, {
    defaultValue: "Cost Analysis",
  });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Higher Loan, Higher Cost"}
      subtitle={subtitle}
