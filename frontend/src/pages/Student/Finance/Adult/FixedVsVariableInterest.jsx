...
const FixedVsVariableInterest = () => {
  ...
  const baseKey = "financial-literacy.adults.fixed-vs-variable-interest";
  ...
  const headerLeft = t(`${baseKey}.sectionHeaderLeft`, {
    defaultValue: "Interest Rate Types",
  });
  const headerRight = t(`${baseKey}.sectionHeaderRight`, {
    defaultValue: "Payment Predictability",
  });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Fixed vs Variable Interest"}
      subtitle={subtitle}
