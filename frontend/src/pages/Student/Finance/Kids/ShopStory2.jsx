...
const ShopStory2 = () => {
  ...
  const gameContent = t("financial-literacy.kids.shop-story-2", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Shop Story 2"}
      subtitle={
        showResult
          ? gameContent?.subtitleComplete || "Story Complete!"
          : t("financial-literacy.kids.shop-story-2.subtitleProgress", {
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex justify-between items-center mb-4">
                <span className="text-white/80">
                  {t("financial-literacy.kids.shop-story-2.questionCounter", {
                    current: currentQuestion + 1,
                    total: questions.length,
                  })}
                </span>
                <span className="text-yellow-400 font-bold">
                  {t("financial-literacy.kids.shop-story-2.scoreLabel", {
                    score: coins,
                    total: questions.length,
                  })}
                </span>
