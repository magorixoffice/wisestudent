...
const ReflexBankSymbols = () => {
  ...
  const gameContent = t("financial-literacy.kids.reflex-bank-symbols", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent.title || "Reflex Banking Symbols"}
      subtitle={
        gameState === "playing"
          ? t("financial-literacy.kids.reflex-bank-symbols.subtitlePlaying", {
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/80 mb-6">
              {t("financial-literacy.kids.reflex-bank-symbols.readyInfo", {
                total: TOTAL_ROUNDS,
                seconds: ROUND_TIME,
