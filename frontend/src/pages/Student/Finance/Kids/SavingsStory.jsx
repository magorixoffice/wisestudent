...
const SavingsStory = () => {
  ...
  const gameContent = t("financial-literacy.kids.savings-story", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Savings Story"}
      subtitle={
        showResult
          ? gameContent?.subtitleComplete || "Story Complete!"
          : t("financial-literacy.kids.savings-story.subtitleProgress", {
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-yellow-400 font-bold">
                  {t("financial-literacy.kids.savings-story.scoreLabel", {
                    score,
                    total: questions.length,
