...
const ReflexBudget = () => {
  ...
  const gameContent = t("financial-literacy.kids.reflex-budget", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Reflex Budget"}
      subtitle={
        gameState === "playing"
          ? t("financial-literacy.kids.reflex-budget.subtitlePlaying", {
              current: currentRound,
              total: TOTAL_ROUNDS,
            })
          : gameContent?.subtitleReady || "Test your budgeting reflexes!"
      }
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              {gameContent?.readyTitle || "Ready to Test Your Budgeting Skills?"}
            </h3>
            <p className="text-white/90 text-lg mb-6">
              {gameContent?.readyDescription || "Answer questions about smart budgeting and money management."}
            </p>
            <p className="text-white/80 mb-6">
              {t("financial-literacy.kids.reflex-budget.readyInfo", {
                total: TOTAL_ROUNDS,
                seconds: ROUND_TIME,
              })}
            </p>
