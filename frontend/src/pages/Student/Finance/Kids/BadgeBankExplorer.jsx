...
const BadgeBankExplorer = () => {
  ...
  const gameContent = t("financial-literacy.kids.badge-bank-explorer", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Badge: Bank Explorer"}
      subtitle={
        showResult
          ? gameContent?.subtitleComplete || "Badge Earned!"
          : t("financial-literacy.kids.badge-bank-explorer.subtitleProgress", {
              current: challenge + 1,
