...
const JournalOfSaving = () => {
  ...
  const gameContent = t("financial-literacy.kids.journal-of-saving", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Journal of Saving"}
      subtitle={
        !showResult
          ? t("financial-literacy.kids.journal-of-saving.subtitleProgress", {
        ...
        {!showResult && stages[currentStage] && (
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
            ...
            <p className="text-white/70 mb-4">
              {t("financial-literacy.kids.journal-of-saving.scoreLabel", {
                score,
                total: stages.length,
              })}
            </p>
            <p className="text-white/60 text-sm mb-4">
              {t("financial-literacy.kids.journal-of-saving.minChars", {
                count: stages[currentStage].minLength,
              })}
            </p>
            <textarea
              value={entry}
            ...
            <div className="mt-2 text-white/50 text-sm">
              {t("financial-literacy.kids.journal-of-saving.charCount", {
            ...
            >
              {currentStage === stages.length - 1
                ? gameContent?.submitFinal || "Submit Final Entry"
                : gameContent?.submitContinue || "Submit & Continue"}
            </button>
          </div>
        )}
      </div>
