...
const QuizBanks = () => {
  ...
  const gameContent = t("financial-literacy.kids.quiz-banks", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Quiz on Banks"}
      subtitle={
        showResult
          ? gameContent?.subtitleComplete || "Quiz Complete!"
          : t("financial-literacy.kids.quiz-banks.subtitleProgress", {
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-yellow-400 font-bold">
                  {t("financial-literacy.kids.quiz-banks.scoreLabel", {
                    score,
                    total: questions.length,
