...
const PosterPlanFirst = () => {
  ...
  const gameContent = t("financial-literacy.kids.poster-plan-first", { returnObjects: true });
  ...
  return (
    <GameShell
      title={gameContent?.title || "Poster: Plan First"}
      subtitle={
        gameContent?.subtitleProgress
          ? t("financial-literacy.kids.poster-plan-first.subtitleProgress", {
              current: currentStage + 1,
              total: stages.length,
            })
          : `Question ${currentStage + 1} of ${stages.length}: Choose posters that promote good planning!`
      }
      coins={score}
      ...
      <div className="text-center text-white space-y-8">
        <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
          ...
          <p className="text-white/70 mb-4">
            {t("financial-literacy.kids.poster-plan-first.scoreLabel", {
              score,
              total: stages.length,
            })}
          </p>
