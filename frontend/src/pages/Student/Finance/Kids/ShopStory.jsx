    ...
    <GameShell
      ...
      subtitle={
        showResult
          ...
          : t("financial-literacy.kids.shop-story.subtitleProgress", {
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex justify-between items-center mb-4">
                <span className="text-white/80">
                  {t("financial-literacy.kids.shop-story.questionCounter", {
                    current: currentQuestion + 1,
                    total: questions.length,
                  })}
                </span>
                <span className="text-yellow-400 font-bold">
                  {t("financial-literacy.kids.shop-story.scoreLabel", {
                    score: coins,
                    total: questions.length,
                  })}
                </span>
                ...
                {currentQuestionData.options &&
                  currentQuestionData.options.map((option) => (
                    ...
                    >
                      ...
                      {option.description ? <p className="text-white/90 text-sm">{option.description}</p> : null}
                    </button>
                  ))}
              </div>
            </div>
