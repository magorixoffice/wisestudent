...
const choices = [
  {
    id: "a",
    title: "Engage with every \"what if.\"",
    outcome: "Anxiety escalates.",
  },
  {
    id: "b",
    title: "Acknowledge thoughts and refocus.",
    outcome: "Mental calm improves.",
  },
  {
    id: "c",
    title: "Suppress thoughts forcefully.",
...
const WhatIfThoughts = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-13";
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to respond to these thoughts"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to respond to these thoughts.
