...
const choices = [
  {
    id: "a",
    title: "Rush both tasks without planning",
    outcome: "Quality reduces and stress increases.",
  },
  {
    id: "b",
    title: "Re-evaluate priorities and adjust effort",
    outcome: "Control improves, though not everything is perfect.",
  },
  {
    id: "c",
    title: "Avoid deciding until the last moment",
...
const DeadlineCollision = () => {
  ...
  const gameId = "brain-young-adult-4";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Adaptive planning");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to handle conflicting deadlines"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Fear of failing both tasks at once.
        </Section>
