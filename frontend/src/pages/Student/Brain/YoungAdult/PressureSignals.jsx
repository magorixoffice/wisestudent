...
const choices = [
  {
    id: "a",
    title: "Ignore the signs and continue working",
    outcome: "Stress builds silently over time.",
  },
  {
    id: "b",
    title: "Slow down and acknowledge the pressure",
    outcome: "Awareness increases and pressure stabilises.",
  },
  {
    id: "c",
    title: "Distract with social media and entertainment",
...
const PressureSignals = () => {
  ...
  const gameId = "brain-young-adult-3";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Stress signal recognition");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to stress signals"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Physical and emotional signs appear but are easy to ignore.
        </Section>
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Stress signal recognition</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default PressureSignals;