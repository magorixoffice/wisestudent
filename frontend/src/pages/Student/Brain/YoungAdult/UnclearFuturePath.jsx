...
const choices = [
  {
    id: "a",
    title: "Avoid making any decision.",
  ...
  {
    id: "c",
    title: "Follow others' choices blindly.",
...
const UnclearFuturePath = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-17";
...
export default UnclearFuturePath;