...
const choices = [
  {
    id: "a",
    title: "Constantly compare progress with others",
    outcome: "Confidence decreases over time.",
  },
  {
    id: "b",
    title: "Limit exposure and refocus on personal goals",
    outcome: "Mental clarity improves.",
  },
  {
    id: "c",
    title: "Dismiss feelings without addressing them",
...
const ComparisonPressure = () => {
  ...
  const gameId = "brain-young-adult-5";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Self-comparison awareness");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to comparison pressure"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Self-comparison awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default ComparisonPressure;