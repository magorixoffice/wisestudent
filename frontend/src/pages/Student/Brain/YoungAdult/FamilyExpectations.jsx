...
const choices = [
  {
    id: "a",
    title: "Suppress feelings and push harder",
    outcome: "Internal stress builds silently.",
  },
  {
    id: "b",
    title: "Communicate limits calmly",
...
const FamilyExpectations = () => {
  ...
  const gameId = "brain-young-adult-7";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Emotional communication awareness");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to family pressure"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Emotional communication awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default FamilyExpectations;