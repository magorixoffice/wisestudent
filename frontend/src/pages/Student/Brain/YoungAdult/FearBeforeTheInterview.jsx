...
const choices = [
  {
    id: "a",
    title: "Avoid preparing to reduce stress",
    outcome: "Confidence drops.",
  },
  {
    id: "b",
    title: "Prepare calmly and accept uncertainty",
    outcome: "Confidence stabilises.",
  },
  {
    id: "c",
    title: "Over-prepare obsessively",
...
const FearBeforeTheInterview = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-12";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Fear-response awareness");
    }
  }, [skillUnlocked]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must decide how to respond to fear.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Fear-response awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default FearBeforeTheInterview;