...
const choices = [
  {
    id: "a",
    title: "Constantly imagine worst-case outcomes",
    outcome: "Anxiety increases over time.",
  },
  {
    id: "b",
    title: "Focus on daily routines and tasks",
    outcome: "Mental balance improves.",
  },
  {
    id: "c",
    title: "Avoid thinking about the result entirely",
...
const TheUnknownResult = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-11";
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to handle the waiting period"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Uncertainty about performance creates constant worry.
        </Section>
...
export default TheUnknownResult;