...
const AfterAMistake = () => {
  ...
  const gameId = "brain-young-adult-18";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Failure response awareness");
    }
  }, [skillUnlocked]);
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Failure response awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
