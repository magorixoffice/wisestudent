...
const choices = [
  {
    id: "a",
    title: "Panic and rush through everything",
...
const LastMinutePanic = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-8";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Task breakdown awareness");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to respond to time pressure"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Task breakdown awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default LastMinutePanic;