...
const choices = [
  {
    id: "a",
    title: "Continue working without breaks",
    outcome: "Energy drops and mistakes increase.",
  },
  {
    id: "b",
    title: "Take short breaks to reset",
    outcome: "Focus stabilises and stress reduces.",
  },
  {
    id: "c",
    title: "Stop completely for the day",
...
const NoBreakDay = () => {
  ...
  const gameId = "brain-young-adult-6";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Energy management awareness");
    }
  }, [skillUnlocked]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Fatigue builds but stopping feels risky.
        </Section>
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Energy management awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
