...
const choices = [
  {
    id: "a",
    title: "Worry about everything",
    outcome: "Anxiety increases.",
  },
  {
    id: "b",
    title: "Focus on controllable actions",
...
const ControlVsConcern = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-9";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Cognitive load awareness");
    }
  }, [skillUnlocked]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Mental overload from constant worry.
        </Section>

        {/* Decision */}
        <Section title="Decision Moment">
          The person must decide where to focus attention.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Cognitive load awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default ControlVsConcern;