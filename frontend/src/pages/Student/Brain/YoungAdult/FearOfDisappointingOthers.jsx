...
const choices = [
  {
    id: "a",
    title: "Internalise pressure silently.",
    outcome: "Internal stress increases.",
  },
  {
    id: "b",
    title: "Communicate honestly about limits.",
    outcome: "Pressure reduces gradually.",
  },
  {
    id: "c",
    title: "Avoid conversations.",
...
const FearOfDisappointingOthers = () => {
  const location = useLocation();
  const gameId = "brain-young-adult-14";
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Expectation management awareness");
    }
  }, [skillUnlocked]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Decide how to handle expectations"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must decide how to handle expectations.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Expectation management awareness</strong>
          </Section>
        )}
      </div>
    </GameShell>
...
export default FearOfDisappointingOthers;